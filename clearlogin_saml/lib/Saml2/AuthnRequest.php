 ...
 *
 */
class Clearlogin_Saml2_AuthnRequest
{
     ...
     */
    public function __construct(Clearlogin_Saml2_Settings $settings, $forceAuthn = false, $isPassive = false)
    {
        ...
        if (isset($security['wantNameIdEncrypted']) && $security['wantNameIdEncrypted']) {
            $nameIDPolicyFormat = Clearlogin_Saml2_Constants::NAMEID_ENCRYPTED;
        }
