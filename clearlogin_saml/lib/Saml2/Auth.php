...
/**
 * Main class of Clearlogin's PHP Toolkit
 *
 */
class Clearlogin_Saml2_Auth
{
    ...
    {
        $this->_settings = new Clearlogin_Saml2_Settings($oldSettings);
    }
    ...
    public function processResponse($requestId = null)
    {
        ...
        if (isset($_POST) && isset($_POST['SAMLResponse'])) {
            ...
            $response = new Clearlogin_Saml2_Response($this->_settings, $_POST['SAMLResponse']);
            ...
            throw new Clearlogin_Saml2_Error(
                ...
                Clearlogin_Saml2_Error::SAML_RESPONSE_NOT_FOUND
            );
        }
    }
    ...
    public function processSLO($keepLocalSession = false, $requestId = null, $retrieveParametersFromServer = false)
    {
        ...
        if (isset($_GET) && isset($_GET['SAMLResponse'])) {
            $logoutResponse = new Clearlogin_Saml2_LogoutResponse($this->_settings, $_GET['SAMLResponse']);
            if (!$logoutResponse->isValid($requestId, $retrieveParametersFromServer)) {
                $this->_errors[] = 'invalid_logout_response';
                $this->_errorReason = $logoutResponse->getError();
            } else if ($logoutResponse->getStatus() !== Clearlogin_Saml2_Constants::STATUS_SUCCESS) {
                $this->_errors[] = 'logout_not_success';
            } else {
                if (!$keepLocalSession) {
                    Clearlogin_Saml2_Utils::deleteLocalSession();
                }
            }
        } else if (isset($_GET) && isset($_GET['SAMLRequest'])) {
            $logoutRequest = new Clearlogin_Saml2_LogoutRequest($this->_settings, $_GET['SAMLRequest']);
            if (!$logoutRequest->isValid($retrieveParametersFromServer)) {
                ...
                $inResponseTo = Clearlogin_Saml2_LogoutRequest::getID(gzinflate(base64_decode($_GET['SAMLRequest'])));
                $responseBuilder = new Clearlogin_Saml2_LogoutResponse($this->_settings);
            ...
            throw new Clearlogin_Saml2_Error(
                ...
                Clearlogin_Saml2_Error::SAML_LOGOUTMESSAGE_NOT_FOUND
            );
        }
    }
    ...
    public function redirectTo($url = '', $parameters = array())
    {
        ...
        Clearlogin_Saml2_Utils::redirect($url, $parameters);
    }

    /**
     * Checks if the user is authenticated or not.
     *
     * @return boolean  Clearlogin if the user is authenticated
     */
    ...
    public function login($returnTo = null, $parameters = array(), $forceAuthn = false, $isPassive = false)
    {
        ...
        $authnRequest = new Clearlogin_Saml2_AuthnRequest($this->_settings, $forceAuthn, $isPassive);
        ...
        if (!empty($returnTo)) {
            ...
            $parameters['RelayState'] = Clearlogin_Saml2_Utils::getSelfRoutedURLNoQuery();
        }
    ...
    public function logout($returnTo = null, $parameters = array(), $nameId = null, $sessionIndex = null)
    {
        ...
        if (empty($sloUrl)) {
            throw new Clearlogin_Saml2_Error(
                ...
                Clearlogin_Saml2_Error::SAML_SINGLE_LOGOUT_NOT_SUPPORTED
            );
        }
        ...
        $logoutRequest = new Clearlogin_Saml2_LogoutRequest($this->_settings, null, $nameId, $sessionIndex);
    ...
    public function buildRequestSignature($samlRequest, $relayState)
    {
        if (!$this->_settings->checkSPCerts()) {
            throw new Clearlogin_Saml2_Error(
                ...
                Clearlogin_Saml2_Error::SP_CERTS_NOT_FOUND
            );
        }
