 ...
 *
 */
class Clearlogin_Saml2_LogoutResponse
{
    ...
    */
     ...
     */
    public function __construct(Clearlogin_Saml2_Settings $settings, $response = null)
    {
        ...
        if ($response) {
            ...
            $this->document = Clearlogin_Saml2_Utils::loadXML($this->document, $this->_logoutResponse);
        }
    }
        ...
        try {
            ...
            if (isset($_GET['Signature'])) {
                ...
                if ($retrieveParametersFromServer) {
                    $signedQuery = 'SAMLResponse='.Clearlogin_Saml2_Utils::extractOriginalQueryParam('SAMLResponse');
